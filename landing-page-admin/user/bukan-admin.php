...
<head>
<title><?php echo $login_status; ?> - PT. KAI - Bukan Admin</title>
...
<div id="wrap">
  ...
  <div id="content">
    <div id="topcol"> <img src="images/wdp.jpg" alt="" width="100" height="100" class="rightalign" />
      ...
      <p><h3>Halaman ini hanya dapat diakses oleh Administrator saja. Tidak termasuk Staff karena konten ini termasuk dalam privasi dan sangat rentan.</h3></p>
      <div class="clear"></div>
    </div>
    <div class="clear"></div>
    <div class="clear"></div>
