...
<div id="center">
			...
			<form action="lengkap.php" method="GET">
				<fieldset>
					<table>
						...
						<tr>
							<td>
							<a href="cek-kode.php"><input type="button" value="Cek Yang Lain" title="Cek Yang Lain" id="submit"></a>
							</td>
						</tr>
					</table>
				</fieldset>
		...
		<div class="Lain">
		Setelah membayar, dapat hubungi Admin di nomor 0852 9270 2172 untuk pengaktifan tiket.
		</div>
  <div class="clear"> </div>
  <div id="footer">
    <div id="btm_cont"> </div>
