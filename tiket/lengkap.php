...
<div id="center">
				...
				<fieldset>
					<table>
						...
						<tr>
							...
							<td> : </td>
							<td><input class="textfield" placeholder="Nama lengkap anda" name="nama" id="nama" type="text" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td> : </td>
							<td><input class="textfield" value="<?php echo $noka ?>" name="noka" id="noka" type="text" readonly /></td>
						</tr>
						<tr>
							<td colspan="4"><h2>Nama KA</h2></td>
							<td> : </td>
							<td><input class="textfield" value="<?php echo $naka ?>" name="naka" id="naka" type="text" readonly /></td>
						</tr>
						<tr>
							<td colspan="4"><h2>Kelas<h2></td>
							<td> : </td>
							<td><input class="textfield" value="<?php echo $kelas ?>" name="kelas" id="kelas" type="text" readonly /></td>
						</tr>
						<tr>
							<td colspan="4"><h2>Dari</h2></td>
							<td> : </td>
							<td><input class="textfield" value="<?php echo $asal ?>" name="dari" id="dari" type="text" readonly /></td>
						</tr>
						<tr>
							<td colspan="4"><h2>Ke</h2></td>
							<td> : </td>
							<td><input class="textfield" value="<?php echo $tuju ?>" name="ke" id="ke" type="text" readonly /></td>
						</tr>
						<tr>
							<td colspan="4"><h2>Tanggal</h2></td>
							<td> : </td>
							<td><input class="textfield" value="<?php echo $tanggal ?>" name="tanggal" id="tanggal" type="text" readonly /></td>
							<td><h3></h3></td>
						</tr>
						<tr>
							<td colspan="4"><h2>Harga</h2></td>
							<td> : </td>
							<td><input class="textfield" value="<?php echo $harga ?>" name="harga" id="harga" type="text" readonly /></td>
						</tr>
						<tr>
							<td>
		...
		<div class="Lain">
		Masukkan hanya Nama, ID, dan Nomor Telepon anda guna keperluan boarding di stasiun.
		</div>
  <div class="clear"> </div>
  <div id="footer">
    <div id="btm_cont"> </div>
