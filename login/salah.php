...
<title>PT. Kereta Ai Indonesia</title>
  ...
  <div id="header">
    <div id="topmenu">
      <ul>
        ...
        <li class="notes.html"><a href="/kai/notes.html">Notes</a> </li>
  ...
  <link href="style.css" rel="stylesheet" type="text/css" />
		<div class="main">
	      <form action="" method="post">
			<h2>USERNAME ATAU PASSWORD SALAH</h2><hr/>		
		...
		<div class="lain">
		Apabila anda lupa password, anda dapat meminta password baru melalui form Kontak.
		</div>
   </div>
  <div class="clear"> </div>
  <div id="footer">
